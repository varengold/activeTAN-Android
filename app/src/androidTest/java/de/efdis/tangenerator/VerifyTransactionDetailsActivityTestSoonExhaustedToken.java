...
public class VerifyTransactionDetailsActivityTestSoonExhaustedToken {
    ...
    public InMemoryDatabaseRule mockDatabaseRule
            = InMemoryDatabaseRule.withSoonExhaustedTanGenerator();
    ...
    public void computeTan() {
        ...
        Espresso.onView(ViewMatchers.withText(R.string.soon_exhausted_generator_description))
                .check(ViewAssertions.matches(ViewMatchers.isDisplayed()));
    }
