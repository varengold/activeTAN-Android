...
import de.efdis.tangenerator.databinding.ActivityImprintBinding;
...
public class ImprintActivity extends AppActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityImprintBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        TextUtils.setHtmlText(binding.imprint, R.string.imprint);
    }
}
